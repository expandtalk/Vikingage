...
const FEATURED: Stone[] = [
  ...
  { signum: 'DR 314', name: 'Hällestadstenen',
    sv: 'Ur Hällestad-gruppen i Skåne (medeltida danskt) — rest av Torgisl m.fl. Gruppen hör till Fyrisvalla-kretsen ("flydde inte vid Uppsala").',
    en: 'From the Hällestad group in Skåne (medieval Danish territory) — raised by Þorgísl and others. The group belongs to the Fyrisvellir circle ("did not flee at Uppsala").' },
