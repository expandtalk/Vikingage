...
const GROUPS: Group[] = [
  {
    ...
    tools: [
      ...
      { icon: Waves, to: '/sv/oland', status: 'beta', titleSv: 'Strandförskjutning & landhöjning (bar mark)', titleEn: 'Shoreline & land uplift (bare earth)',
        descSv: 'Höj havet till dåtida nivå och se hur kusten låg. På Öland används Lantmäteriets markhöjdmodell (1 m) — bar mark där skog/träd är bortfiltrerade — för en sannare strandlinje; djuptid via SGU. Avfärdar "kultplats" som då låg under vatten.',
        descEn: 'Raise the sea to past levels to see the former coast. On Öland it uses Lantmäteriet’s 1 m elevation model — bare earth with forest/trees filtered out — for a truer shoreline; deep time via SGU. Debunks "cult sites" that were then underwater.' },
  ...
  },
  {
    ...
    tools: [
      ...
      { icon: Dna, to: '/explore?focus=geneticEvents', status: 'live', titleSv: 'Genetik & osteologi', titleEn: 'Genetics & osteology',
        descSv: 'aDNA-platser, härkomstkomponenter och skelettmaterial kopplat till individ och plats — öppnar kartan med genetik-/osteologilagret tänt.',
        descEn: 'aDNA sites, ancestry components and skeletal material tied to individual and place — opens the map with the genetics/osteology layer enabled.' },
    ],
  },
  {
