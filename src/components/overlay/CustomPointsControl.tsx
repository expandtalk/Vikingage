...
import { MapPin, Plus, Trash2, Hexagon } from 'lucide-react';
...
export const CustomPointsControl: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-4 left-4 z-[1100] w-72 bg-slate-900 border border-slate-600 rounded-lg shadow-2xl">
      <button onClick={() => setOpen((o) => !o)} className="w-full flex items-center justify-between px-3 py-2 text-white text-xs font-medium">
