...
const CARDS: LauncherCard[] = [
  { to: '/inscriptions', sv: 'Runstenar', en: 'Runestones', dsv: 'Hela runstenskorpusen — filtrera på karta.', den: 'The whole runestone corpus — filter on a map.', count: (s) => s.totalRunestones },
