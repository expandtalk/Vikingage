...
('f27d4aed-4b68-4f90-861b-7e1553a055f7','E DR419','DR 419',51.2797,1.08145,'kuril sarþuara far þu nu funtin istu þur uigi þik þorsa trutin iuril sarþuara uiþr aþra uari ·','"Gyrill sárþvara, far þú nú, fundinn ertu; "Þórr vígi þik, þursa dróttinn, "Gyrill sárþvara. Viðr aðra vari.',NULL,'Gyril wound-causer, go now, you are found. Thor hallow you (to perdition), lord of giants (demons), Gyril wound-causer. Against blood-poison (literally: blood-vessel pus).','Efter 1073','Samma som E DR419.

Sedan fyndet av U NOR1998;25 i Sigtuna som inleds med runföljden <iorils> kan emenderingen av <iuril> till <kuril> i DR och Moltke 1985 ifrågasättas.','Handskrift','Pergament',NULL,'Sweden'),
...
('4c725435-abdf-421c-94a1-a1ff0ccd75ef','E 2','Br E2|DR 412',51.5129,-0.0975336,': k-na : let : legia : st¶in : þensi : auk : tuki :','"G[i]nna(?)/"G[í]na(?) lét leggja stein þenna ok "Tóki.',NULL,'Ginna(?)/Gína(?) had this stone laid and (i.e. with) Tóki.','Början av 1000-talet','Samma som E 2.

Reliefhuggen, mörkblå och röd färg.','Gavelsten i gravkista','Kalksten',NULL,'Sweden'),
