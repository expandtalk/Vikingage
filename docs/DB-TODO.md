...
- [ ] **Gör rollout-importen alias-medveten** innan den körs (annars skapar den fler dubbletter): skippa signum vars alias redan finns som rad. **Efter rollout: kör dedupen igen** för att städa de 179 kvarvarande B/BN.
