-- SKALNING fas 2: lägg matching_places, waypoints, lit och archive_images i answer_bundle → ytterligare
-- 4 alltid-fyrande DB-anrop bakas in i den enda round-trippen (nu 12 lookups i ett anrop).
-- (matching_places returneras RÅ prefix-matchad; klienten behåller sin ranking/slice — identisk logik.)
