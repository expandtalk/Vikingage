-- STEG 2: search_v1 använder blandad popularity_score (80% wiki / 20% klick, normaliserad)
-- i st.f. rå wiki-popularity. prominence trumfar separat. Klick ändrar bara synlighet, ej fakta.
-- (Genererad ur live-funktionen efter den kirurgiska ersättningen av wiki-multiplikatorn.)
