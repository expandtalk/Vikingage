-- #1 Domkyrkor är alltid notable (undanta dem från kyrko-exkluderingen i sites).
-- #3 Kalmarsund-blödning löst med Öland-fyrkant (Daniels förslag): samma-landmassa-villkor.
--    Öland-bbox ur data (Borgholm+Mörbylånga heritage, percentiler): lat 56.19–57.37, lng 16.40–17.13.
--    Kalmar (lng 16.356) ligger VÄSTER om 16.40 → utanför. Regel: center-på-Öland == feature-på-Öland
--    (boolesk likhet) → Öland-orter drar bara Öland, fastland drar ej Öland, åt båda håll.
