-- entity_answer_context: höj inskrifts-taket 80→400 så räknaren blir korrekt (var globalt kapad
-- till 80 → 'RUNESTONES · 80' identiskt för alla platser). Repo-spegling. 2026-08-06.
