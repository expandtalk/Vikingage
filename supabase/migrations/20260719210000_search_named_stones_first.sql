-- Sorterar namngivna stenar (t.ex. Karlevistenen) först bland träffarna. Exakt
-- signum-/aliasmatch vinner fortfarande (tier 1-4); därefter kommer stenar med name
-- före namnlösa, sedan prefix + nummer. Övrigt oförändrat mot 20260719120000.
