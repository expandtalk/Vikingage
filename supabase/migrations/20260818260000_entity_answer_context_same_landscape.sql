-- #9 Bildrelevans: entity_answer_context drog landmärkesbilder inom 20 km → för Kalmar
-- fångade det Öland-kyrkor över sundet. Kräv nu att landmärket ligger i SAMMA landskap som
-- platsens centrum (via admin_boundaries level=landskap). place_context-grenen oförändrad.
