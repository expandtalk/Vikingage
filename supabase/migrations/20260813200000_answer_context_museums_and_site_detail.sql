-- Stad-svar rikare (Göteborg-diagnos): (1) sites bär nu parish + description så generiska RAÄ-namn
-- ("Hällristning") kan särskiljas/klickas för vad de ÄR; (2) nytt museums-lager (museums-tabellen fanns
-- men saknades i svaret). Behåller domkyrka-undantag + Öland-polygon från 20260813130000.
